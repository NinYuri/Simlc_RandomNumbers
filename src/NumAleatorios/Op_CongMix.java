...
public class Op_CongMix extends JFrame implements ActionListener
{
			...
			if(sem.isEmpty())
			{
				...
				if(Entero(sem) == false)
				{
					...
					if(Integer.parseInt(sem) <= 0)
					{
						...
						if(Par(Integer.parseInt(sem)) == true)
						{
			...
			if(a.isEmpty())
			{
				...
				if(Entero(a) == false)
				{
					...
					if(Integer.parseInt(a) <= 0)
					{
						...
						if(ImparA(Integer.parseInt(a)) == false)
						{
							JOptionPane.showMessageDialog(this, "El valor de a debe ser un número impar no divisible por 3 ni por 5", 
									"Error de constantes", JOptionPane.ERROR_MESSAGE);
							txta.setText("");
							return;
						}
			if(c.isEmpty())
			{
				...
				if(Entero(c) == false)
				{
					...
					if(Integer.parseInt(c) <= 0)
					{
						...
						if(Modulo(Integer.parseInt(c)) != true)
						{
							JOptionPane.showMessageDialog(this, "El valor de c%8 debe ser igual a 5", 
									"Error de constantes", JOptionPane.ERROR_MESSAGE);
							txtc.setText("");
							return;
						}
	...
	private static boolean Par(int sem)
	{
		if(sem % 2 == 0)
			return true;
		else
	...
	private static boolean ImparA(int a)
	{
		boolean ban = false;
		if(a % 2 != 0)
		{
	...
	private static boolean Modulo(int c)
	{
		if(c % 8 == 5)
			return true;
		else
