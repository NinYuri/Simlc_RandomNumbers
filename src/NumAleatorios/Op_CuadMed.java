...
public class Op_CuadMed extends JFrame implements ActionListener
{
	...
	private JButton bttmed = new JButton("Prueba de Media");
	private JButton bttvar = new JButton("Prueba de Varianza");
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource() == bttgenerar || e.getSource() == bttregre)
		{
			...
			if(sem.isEmpty())
			{
				...
				if(sem.length() != 4)
				{
					JOptionPane.showMessageDialog(this, "La semilla debe tener, como mínimo, 4 dígitos", 
							"Error de semilla", JOptionPane.ERROR_MESSAGE);
					txtsem.setText("");
					return;
				}
